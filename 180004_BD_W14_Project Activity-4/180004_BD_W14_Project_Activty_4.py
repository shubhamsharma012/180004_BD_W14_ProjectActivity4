...
# ### Ans 3. (B) Plotting the Relation between Age, Annual Income and Spending Score
...
# ###  Ans 3. (C) Distribution of values in Age, Annual Income and Spending Score according to Gender
...
# ### Ans 4. (A) Clustering using K-means: Segmentation using Age and Spending Score
...
# ### Ans 4. (B) Clustering using K-means: Segmentation using Annual Income and Spending Score
...
# ### Ans 5. (C) Clustering using K-Means: Segmentation using Age, Annual Income and Spending Score
# 
...
# ### Ans 6. Plotting the Cluster Boundary and Clusters
